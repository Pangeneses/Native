...
{
	CHV4DZNEGATIVE < int8_t > ::CHV4DZNEGATIVE() { Data = -1i8; }

	CHV4DZNEGATIVE < int8_t > ::CHV4DZNEGATIVE(CHV4DZNEGATIVE < int8_t > const& x) { Data = x(); }

	CHV4DZNEGATIVE < int8_t > ::CHV4DZNEGATIVE(int8_t const& x) { Data = x; }

	void CHV4DZNEGATIVE < int8_t > ::operator=(CHV4DZNEGATIVE < int8_t > const& x) { Data = x(); }

	void CHV4DZNEGATIVE < int8_t > ::operator=(int8_t  const& x) { Data = x; }

	int8_t CHV4DZNEGATIVE < int8_t > ::operator()() const { return Data; }

	unsigned char& CHV4DZNEGATIVE < int8_t > ::operator[](size_t const& i)
	{
	...
	CHV4DZNEGATIVE < int8_t > CHV4DZNEGATIVE < int8_t > ::operator++()
	{
	...
	CHV4DZNEGATIVE < int8_t > CHV4DZNEGATIVE < int8_t > ::operator++(int)
	{
		if (Data == -1i8) throw std::overflow_error{ "ZNegative Increment Overflow." };
	...
	CHV4DZNEGATIVE < int8_t > CHV4DZNEGATIVE < int8_t > ::operator+() const
	{
		return int8_t{ Data };
	}
	...
	CHV4DZNEGATIVE < int8_t > CHV4DZNEGATIVE < int8_t > ::operator+(CHV4DZNEGATIVE < int8_t > const& x) const
	{
		int16_t A{ Data }, B{ x() };
	...
	CHV4DMANTISSA < double > CHV4DZNEGATIVE < int8_t > ::operator/(CHV4DMANTISSA < double > const& x) const
	{
	...
	size_t CHV4DZNEGATIVE < int8_t > ::operator%(CHV4DZNEGATIVE < int8_t > const& x) const
	{
	...
	bool CHV4DZNEGATIVE < int8_t > ::operator!() const
	{
		return !Data;
	}

	bool CHV4DZNEGATIVE < int8_t > ::operator&&(CHV4DZNEGATIVE < int8_t > const& x) const
	{
		return Data && x();
	}
	...
	std::strong_ordering CHV4DZNEGATIVE < int8_t > ::operator<=>(CHV4DZNEGATIVE < int8_t > const& x) const
	{
		return Data <=> x();
	}

	void CHV4DZNEGATIVE < int8_t > ::operator+=(CHV4DZNEGATIVE < int8_t > const& x)
	{
