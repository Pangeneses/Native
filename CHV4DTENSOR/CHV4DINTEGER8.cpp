...
namespace CHV4DTENSOR
{
	...
	CHV4DINTEGER < int8_t > ::CHV4DINTEGER(CHV4DINTEGER const& x) { Data = x(); }

	CHV4DINTEGER < int8_t > ::CHV4DINTEGER(int8_t const& x) { Data = x; }


	void CHV4DINTEGER < int8_t > ::operator=(CHV4DINTEGER const& x) { Data = x(); }
	...
	CHV4DINTEGER< int8_t > CHV4DINTEGER< int8_t > ::operator+(CHV4DINTEGER const& x) const
	{
		int16_t A{ Data }, B{ x() };
	...
	double CHV4DINTEGER< int8_t > ::operator/(double const& x) const
	{
	...
	bool CHV4DINTEGER< int8_t > ::operator&&(CHV4DINTEGER const& x) const
	{
		return Data && x();
	}
	bool CHV4DINTEGER< int8_t > ::operator||(CHV4DINTEGER const& x) const
	...
	std::weak_ordering CHV4DINTEGER< int8_t > ::operator<=>(CHV4DINTEGER const& x) const
	{
		return Data <=> x();
	}

	void CHV4DINTEGER< int8_t > ::operator+=(CHV4DINTEGER const& x)
	{
	...
	void CHV4DINTEGER< int8_t > ::operator/=(CHV4DINTEGER const&) {}
