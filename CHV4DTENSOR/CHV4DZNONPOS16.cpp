...
{
	CHV4DZNONPOS < int16_t > ::CHV4DZNONPOS() { Data = 0i16; }

	CHV4DZNONPOS < int16_t > ::CHV4DZNONPOS(CHV4DZNONPOS < int16_t > const& x) { Data = x(); }

	CHV4DZNONPOS < int16_t > ::CHV4DZNONPOS(int16_t const& x) { Data = x; }

	void CHV4DZNONPOS < int16_t > ::operator=(CHV4DZNONPOS < int16_t > const& x) { Data = x(); }

	void CHV4DZNONPOS < int16_t > ::operator=(int16_t  const& x) { Data = x; }

	int16_t CHV4DZNONPOS < int16_t > ::operator()() const { return Data; }

	unsigned char& CHV4DZNONPOS < int16_t > ::operator[](size_t const& i)
	{
	...
	CHV4DZNONPOS < int16_t > CHV4DZNONPOS < int16_t > ::operator++()
	{
	...
	CHV4DZNONPOS < int16_t > CHV4DZNONPOS < int16_t > ::operator++(int)
	{
		if (Data == 0i16) throw std::overflow_error{ "ZNonPos Increment Overflow." };
	...
	CHV4DZNONPOS < int16_t > CHV4DZNONPOS < int16_t > ::operator+() const
	{
		return int16_t{ Data };
	}
	...
	CHV4DZNONPOS < int16_t > CHV4DZNONPOS < int16_t > ::operator+(CHV4DZNONPOS < int16_t > const& x) const
	{
		int32_t A{ Data }, B{ x() };
	...
	CHV4DMANTISSA < double > CHV4DZNONPOS < int16_t > ::operator/(CHV4DMANTISSA < double > const& x) const
	{
	...
	size_t CHV4DZNONPOS < int16_t > ::operator%(CHV4DZNONPOS < int16_t > const& x) const
	{
	...
	CHV4DZNONPOS < int16_t > CHV4DZNONPOS < int16_t > ::operator|(CHV4DZNONPOS const x) const
	{
		return Data | x();
	}
	...
	bool CHV4DZNONPOS < int16_t > ::operator!() const
	{
		return !Data;
	}

	bool CHV4DZNONPOS < int16_t > ::operator&&(CHV4DZNONPOS < int16_t > const& x) const
	{
		return Data && x();
	}
	...
	std::strong_ordering CHV4DZNONPOS < int16_t > ::operator<=>(CHV4DZNONPOS < int16_t > const& x) const
	{
		return Data <=> x();
	}

	void CHV4DZNONPOS < int16_t > ::operator+=(CHV4DZNONPOS < int16_t > const& x)
	{
