...
namespace CHV4DTENSOR
{
	...
	CHV4DINTEGER < int32_t > ::CHV4DINTEGER(CHV4DINTEGER const& x) { Data = x(); }

	CHV4DINTEGER < int32_t > ::CHV4DINTEGER(int32_t const& x) { Data = x; }


	void CHV4DINTEGER < int32_t > ::operator=(CHV4DINTEGER const& x) { Data = x(); }
	...
	double CHV4DINTEGER< int32_t > ::operator/(double const& x) const
	{
	...
	bool CHV4DINTEGER< int32_t > ::operator&&(CHV4DINTEGER const& x) const
	{
		return Data && x();
	}
	bool CHV4DINTEGER< int32_t > ::operator||(CHV4DINTEGER const& x) const
	...
	std::weak_ordering CHV4DINTEGER< int32_t > ::operator<=>(CHV4DINTEGER const& x) const
	{
		return Data <=> x();
	}

	void CHV4DINTEGER< int32_t > ::operator+=(CHV4DINTEGER const& x)
	{
	...
	void CHV4DINTEGER< int32_t > ::operator/=(CHV4DINTEGER const&) {}
