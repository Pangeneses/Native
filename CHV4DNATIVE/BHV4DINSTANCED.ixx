...
export module CHV4DNATIVE:BHV4DINSTANCED;
...
{
	class BHV4DINSTANCED
	{
	public:
		BHV4DINSTANCED() = default;

        BHV4DINSTANCED(SysT::CHV4DHASH const& uid)
        {
            UUID = uid;
    ...
    private:
        ...
        std::map<CHV4DTBASIC::CHV4DHASH, Mesh> Reference;

        std::map<CHV4DTBASIC::CHV4DHASH, std::vector<World>> Instance;
